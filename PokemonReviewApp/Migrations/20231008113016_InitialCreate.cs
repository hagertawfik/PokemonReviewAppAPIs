    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PokemonCategeroies", x => new { x.PokemonId, x.CategeroyId });
                    table.ForeignKey(
                        name: "FK_PokemonCategeroies_Categories_CategeroyId",
                        column: x => x.CategeroyId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PokemonCategeroies_Pokemons_PokemonId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PokemonCategeroies_CategeroyId",
                table: "PokemonCategeroies",
                column: "CategeroyId");
